...
$users = “vuniyal@peopleschoicecu.com.au”
...
# REPORT PROPERTIES
# Path to the report
$reportPath = “C:\Windows\Diskspace\Reports”
# Report name
...
$computers = Get-Content “C:\Windows\Diskspace\Reports\servers.txt”
$datetime = Get-Date -Format “MM-dd-yyyy_HHmmss”

# Remove the report if it has already been run today so it does not append to the existing report
If (Test-Path $diskReport)
{
Remove-Item $diskReport -Force
}
...
Get-ChildItem $reportPath | Where-Object { $_.LastWriteTime -lt $DatetoDelete } | Remove-Item -Force
...
$msg.To.Add($user)
$msg.From = “PCCUServerMonitoring@Peopleschoice.COM”
$msg.Subject = “PCCU Server DiskSpace Report for $titledate”
$msg.IsBodyHTML = $true
