...
$ADR = Get-CMAutoDeploymentRule -Fast -Name $ADRName
    ...
    $DeploymentDetails = @(
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.0";AvailableHours="291";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.1";AvailableHours="315";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.2";AvailableHours="339";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.3";AvailableHours="363";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.4";AvailableHours="435";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.5";AvailableHours="459";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.6";AvailableHours="483";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.7";AvailableHours="507";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.8";AvailableHours="531";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.9";AvailableHours="603";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.A";AvailableHours="627";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.B";AvailableHours="651";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.C";AvailableHours="675";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.D";AvailableHours="699";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.E";AvailableHours="771";RequiredHours="3"},
        [pscustomobject]@{CollectionName="SU.Workstations.Dynamic.F";AvailableHours="795";RequiredHours="3"}
