...
Function DoDynamicCollections{
    ...
    $StaticCollections = @(
        [pscustomobject]@{Name="SU.Workstations.Dynamic.0-1";LimitCollection="All Windows Workstations";Query="select * from SMS_R_System where SMS_R_System.SMSUniqueIdentifier like `"%0`" or SMS_R_System.SMSUniqueIdentifier like `"%1`""},
        [pscustomobject]@{Name="SU.Workstations.Dynamic.2-3";LimitCollection="All Windows Workstations";Query="select * from SMS_R_System where SMS_R_System.SMSUniqueIdentifier like `"%2`" or SMS_R_System.SMSUniqueIdentifier like `"%3`""},
        [pscustomobject]@{Name="SU.Workstations.Dynamic.4-5";LimitCollection="All Windows Workstations";Query="select * from SMS_R_System where SMS_R_System.SMSUniqueIdentifier like `"%4`" or SMS_R_System.SMSUniqueIdentifier like `"%5`""},
        [pscustomobject]@{Name="SU.Workstations.Dynamic.6-7";LimitCollection="All Windows Workstations";Query="select * from SMS_R_System where SMS_R_System.SMSUniqueIdentifier like `"%6`" or SMS_R_System.SMSUniqueIdentifier like `"%7`""},
        [pscustomobject]@{Name="SU.Workstations.Dynamic.8-9";LimitCollection="All Windows Workstations";Query="select * from SMS_R_System where SMS_R_System.SMSUniqueIdentifier like `"%8`" or SMS_R_System.SMSUniqueIdentifier like `"%9`""},
        [pscustomobject]@{Name="SU.Workstations.Dynamic.A-B";LimitCollection="All Windows Workstations";Query="select * from SMS_R_System where SMS_R_System.SMSUniqueIdentifier like `"%A`" or SMS_R_System.SMSUniqueIdentifier like `"%B`""},
        [pscustomobject]@{Name="SU.Workstations.Dynamic.C-D";LimitCollection="All Windows Workstations";Query="select * from SMS_R_System where SMS_R_System.SMSUniqueIdentifier like `"%C`" or SMS_R_System.SMSUniqueIdentifier like `"%D`""},
        [pscustomobject]@{Name="SU.Workstations.Dynamic.E-F";LimitCollection="All Windows Workstations";Query="select * from SMS_R_System where SMS_R_System.SMSUniqueIdentifier like `"%E`" or SMS_R_System.SMSUniqueIdentifier like `"%F`""}
    )
